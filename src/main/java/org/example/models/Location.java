...
public class Location {
    ...
    private final BlockingQueue<Plants> plants = new LinkedBlockingQueue<>(SimulationSettings.MAX_PLANTS_PER_CELL);
    ...
    public double eatPlants(double amount) {
        ...
        int maxToEat = (int) (amount / Plants.WEIGHT);
        ...
        return eaten * Plants.WEIGHT; // Возвращаем вес съеденных растений
    }
    ...
    public void growPlants() {
        ...
        for (int i = 0; i < newPlants; i++) {
            plants.add(new Plants()); // Создаем новое растение и добавляем его в очередь
        }
    }
    ...
    public String getDominantAnimalInfo() {
        ...
        if (dominant != null) {
            try {
                String emoji = String.valueOf(dominant.getKey().getDeclaredConstructor().newInstance().getEmoji()); // Получаем эмодзи для доминирующего животного
