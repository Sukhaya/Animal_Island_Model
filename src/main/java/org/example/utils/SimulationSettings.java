...
import org.example.models.natural_community.predators.*;
...
public class SimulationSettings {
     ...
     * При значении 5 статистика будет выводиться каждый день.
     */
     ...
     */
    public static final double DAILY_SATIETY_LOSS = 0.1;
     ...
     */
    public static final int PLANT_GROWTH_PER_DAY = 70;
    ...
    public static final class EatingChance {
        ...
        public static final int BEAR_BUFFALO = 20;
    ...
    public static final class InitialCount {
        ...
        public static final int CATERPILLAR = 1000; // Начальное количество гусениц
    }
}
